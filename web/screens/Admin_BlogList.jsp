        ...
        <div class="overview">
          ...
          <div class="boxes">
            <div class="recent-order">
              ...
              <div class="product-add"><a  href="admin-create-blog-category">Add new Blog</a></div>
              <div class="product-content">
                <table>
                  ...
                  <c:forEach items="${blogs}" var="c">
                    <tr>
                        <td><img src="https://static.ybox.vn/2019/3/3/1552467364184-Malena1-640x360.jpg" alt="image"/></td>
                      <td>${c.title}</td>
                      <td>Kieu Viet Kien</td>
