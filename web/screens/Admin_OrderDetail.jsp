...
<html>
    <head>
        ...
        <link rel="stylesheet" href="styles/admin-order-detail.css" type="text/css"/>
                ...
                <div class="shopping-cart">
                    ...
                    <td>
                        <div class="quantity-buttons">
                            ...
                            <span class="quantity-value"><input class="q-value" data-value="<%=quantity%>" id="quantity[<%=list.indexOf(order)%>]" name="quantity[<%=list.indexOf(order)%>]" type="number" min="1" max="<%=quantity%>" value="<%=order.getQuantity()%>" readonly></span>
