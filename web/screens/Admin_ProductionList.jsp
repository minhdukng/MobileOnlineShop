          ...
          <div class="boxes">
            <div class="recent-order">
              <div class="product-title">
                ...
                <div class="product-add"><a  href="admin-create-product">Add new Product</a></div>
                ...
                <table>
                  ...
                  <c:forEach items="${list}" var="p">
                    <tr>
                      ...
                      <td>${p.pin}</td>
                      <td>${p.chipset}</td>
                      <td>${p.screenResolution}</td>
                      <td><a href="admin-update-product?id=${p.id}"><i class="bx bxs-edit-alt icon"></i></a></td>
