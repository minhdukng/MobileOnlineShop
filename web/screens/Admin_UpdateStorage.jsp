          ...
          <div class="boxes">
            <div class="add-form">
              <div class="product-title">
                  <i class='bx bx-memory-card icon' ></i>&nbsp;Update Storage
              </div>
              <hr />
              <form class="add-product" action="update-storage" method="POST">
                  <input type="hidden" id="storageId" name="storageId" value="${storage.id}" />
                <label for="size">Storage Size</label><br />
                <input type="text" id="size" name="size" required  value="${storage.storageSize}"/><br />
                ...
                <input
                  ...
                  name="price"
                  step="0.01"
                  required style="margin-bottom: 7vh" value="${storage.priceBonus}"
                /><br />
