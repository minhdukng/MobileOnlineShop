 ...
 * @author kienk
 */
public class AdminCreateColorController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("screens/Admin_CreateColor.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String hexCode = request.getParameter("hex");
        float priceBonus = Float.parseFloat(request.getParameter("price"));
        Color c = new Color(0, color, priceBonus, hexCode, 1);
        cd.createColor(c);
